...
$(function() {
    ...
    var applicationValidationSettings = {
        rules: {
            valFirstName: {
                required: true
            },
    ...
    $.extend(applicationValidationSettings, config.validations);

    $('#application-form').validate(applicationValidationSettings);
})


//Application-Search Form validation
$(function() {
    if (!$('#application-search-form').length) {
        return false;
    }

    var appSearchValidationSettings = {
        rules: {
            valSearchValue: {
                required: true
            }
    ...
    $.extend(appSearchValidationSettings, config.validations);

    $('#application-search-form').validate(appSearchValidationSettings);
})
...
//Application-Search Form validation
$(function() {
    if (!$('#daily_monthly_services').length) {
        return false;
    }

    var appFilterDateValidationSettings = {
        rules: {
            valDateStart: {
                required: true
            },
    ...
    $.extend(appFilterDateValidationSettings, config.validations);

    $('#daily_monthly_services').validate(appFilterDateValidationSettings);
})
...
//Application-Search Form validation
$(function() {
    if (!$('#application_manage_service_form').length) {
        return false;
    }

    var appAddServiceDateValidationSettings = {
        rules: {
            valServiceName: {
                required: true
            },
    ...
    $.extend(appAddServiceDateValidationSettings, config.validations);

    $('#application_manage_service_form').validate(appAddServiceDateValidationSettings);
})
