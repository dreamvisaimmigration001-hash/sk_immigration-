                    ...
                    <div className="sidebar">
                        <div className="sidebar-widget sidebar-categories">
                            <ul className="categories-list clearfix">
						        ...
						        <li><Link to="/schengen_medical.php" className="active">Medical Treatment<Send className="flaticon-send" /></Link></li>
                            </ul>
                        </div>
                      ...
                      <div className="accordion" id="accordionExample">
                        ...
                        <div id="collapseOne" className="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
						  ...
						  <h4 className="mb-2">Overview</h4>
                            <p className="mb-2">Individuals travelling to Slovakia with the purpose of medical treatment can apply.</p>
                          </div>
                        </div>
                ...
                <div className="two-column">
						...
						<div id="collapseThree" className="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
						  ...
						  <h4 className="mb-2">Document requirements</h4>
                            <br />
							<p className="mb-2">Document Checklist – Schengen - <a href="/assets/pdf/checklists/Document_Checklist-Schengen.pdf" target="_blank">Click here</a></p>
                          {/* p className="mb-2">Checklist for medical treatment - <a href="/assets/pdf/checklists/Checklist_for_Visit_Family_or_Friends_Visa.pdf" target="_blank">Click here</a></p */}
...
export default SchengenMedical;
