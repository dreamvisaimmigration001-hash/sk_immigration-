                    ...
                    <div className="sidebar">
                        <div className="sidebar-widget sidebar-categories">
                            <ul className="categories-list clearfix">
                                <li><Link to="/schengen_tourism.php" className="active">Tourism<Send className="flaticon-send" /></Link></li>
						        ...
						        <li><Link to="/schengen_cul_spo_rel.php">Cultural, Sports or Religious events and for film crews<Send className="flaticon-send" /></Link></li>
                      ...
                      <div className="accordion" id="accordionExample">
                        ...
                        <div id="collapseOne" className="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
						  ...
						  <h4 className="mb-2">Overview</h4>
                            <p className="mb-2">Individuals travelling to Slovakia with the purpose of tourism can apply.</p>
                            <br />
                          </div>
                        </div>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" className="feetable">
                ...
                <div className="two-column">
						...
						<div id="collapseThree" className="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                          ...
                          {/* p className="mb-2">Checklist for tourism - <a href="/assets/pdf/checklists/Checklist_for_Tourism_Visa.pdf" target="_blank">Click here</a></p */}
                          <p className="mb-2">Application Form - <a href="/assets/pdf/application_form/Visa_Application_From-Schengen.pdf" target="_blank">Click here</a></p><br />
                          <p className="mb-2">Travel insurance is mandatory for all Schengen countries.</p>
                          <br />
                          </div>
                        </div>
...
<p className="mb-2">From the date of receipt of application at the Embassy of Slovakia, it takes 15 {/* to 45 */} working days to process the visa application. The duration of days when the application is in transit between the Visa Application Centre and the Embassy are not counted.</p>                          </div>
              ...
              <p>&nbsp;</p>
                            ...
                            {/* div className="text">
                            <h4 className="mb-2">Overview</h4>
                            <p className="mb-2">Individuals travelling to Slovakia with the purpose of tourism can apply for tourism Schengen Visa.</p>
							<p className="mb-2"><strong>Please Note:</strong> If you are traveling in more than one Schengen country, please make sure that your longest stay (counting by nights spent) is in Slovakia or in case days of stay are the same in more than one country be sure that Slovakia is the first country of entry in Schengen area. </p>
                            </div>
                        </div>
                        <div className="two-column">
                            <div className="content-box">
                                ...
                                <div className="content-style-two mt-4">
                                								<h4 className="mb-2">Document Requirements</h4>
								<ul className="list clearfix mt-3 mb-3">
                                   <li>Travel insurance is mandatory for all Schengen countries.</li></ul></br>
								<h4 className="mb-2">Photo Specifications</h4>
																                                    </div>
                            </div>
                        </div */}
...
export default SchengenTourism;
