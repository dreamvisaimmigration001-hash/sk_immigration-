                    ...
                    <div className="sidebar">
                        <div className="sidebar-widget sidebar-categories">
                            <ul className="categories-list clearfix">
						        ...
						        <li><Link to="/schengen_business.php" className="active">Business<Send className="flaticon-send" /></Link></li>
                      ...
                      <div className="accordion" id="accordionExample">
                        ...
                        <div id="collapseOne" className="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
						  ...
						  <h4 className="mb-2">Overview</h4>
                             {/* p className="mb-2">Individuals travelling to Slovakia for business purposes can apply as walk in at our visa application center only if they are having an Original Notarized Invitation Letter.</p>
                             <p className="mb-2">In addition to this , please make a note that  submission at the visa center is strictly on the basis of daily limit which is approved by the Embassy .</p */}
							 <p className="mb-2">Applicants who are travelling to Slovakia for business purpose are requested to schedule online appointment for the submission of their documents.</p>
                            <br />
                          </div>
                        </div>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" className="feetable">
                ...
                <div className="two-column">
						...
						<div id="collapseThree" className="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                          ...
                          {/* p className="mb-2">Checklist for Business - <a href="/assets/pdf/checklists/Checklist_for_Business_Visa.pdf" target="_blank">Click here</a></p */}
...
<p className="mb-2">From the date of receipt of application at the Embassy of Slovakia, it takes 15 {/* to 45 */} working days to process the visa application. The duration of days when the application is in transit between the Visa Application Centre and the Embassy are not counted.</p>                          </div>
              ...
              <p>&nbsp;</p>
                            ...
                            {/* div className="text">
                            <h4 className="mb-2">Overview</h4>
                            <p className="mb-2">Individuals travelling to Slovakia for business purposes can apply for business Schengen Visa. Please note that applicants applying for a Business are required to provide documents according to this category as defined by the Schengen harmonized list for China.</p>
                            </div>
                        </div>
                        <div className="two-column">
                            <div className="content-box">
...
export default SchengenBusiness;
