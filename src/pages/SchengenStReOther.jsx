			...
			<div className="auto-container">
				<div className="content-box">
					<div className="title-box">
						<h1>Study, Research or other types of Internship</h1>
					...
					<ul className="bread-crumb clearfix">
						...
						<li>Study, Research or other types of Internship</li>
					</ul>
				</div>
			</div>
                    ...
                    <div className="sidebar">
                        <div className="sidebar-widget sidebar-categories">
                            <ul className="categories-list clearfix">
								...
								<li><Link to="/schengen_st_re_other.php" className="active">Study, Research or other types of Internship<Send className="flaticon-send" /></Link></li>
                    ...
                    <div className="coaching-details-content service-details-content">
                        <div className="content-style-one">
                            ...
                            <div className="group-title">
                                <h2>Study, Research or other types of Internship</h2>
                                <div className="dotted-box"> <span className="dotted"></span> <span className="dotted"></span> <span className="dotted"></span> </div>
                            </div>
							</div>
                      ...
                      <div className="accordion" id="accordionExample">
                        ...
                        <div id="collapseOne" className="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
						  ...
						  <h4 className="mb-2">Overview</h4>
                            <p className="mb-2">Individuals travelling to Slovakia with the purpose of study, research or other types of internship can apply.</p>
                          </div>
                        </div>
...
<table border="0" cellspacing="0" cellpadding="0" width="100%" className="feetable">
                ...
                <div className="two-column">
						...
						<div id="collapseThree" className="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                          ...
                          {/* p className="mb-2">Checklist for study, research or other types of internship - <a href="/assets/pdf/checklists/Checklist_for_Visit_Family_or_Friends_Visa.pdf" target="_blank">Click here</a></p */}
...
export default SchengenStReOther;
