          ...
          <div className="widget-section">
            <div className="row clearfix">
                ...
                <div className="footer-widget links-widget">
                  ...
                  <div className="widget-content">
                    <ul className="list clearfix">
                      ...
                      <li>
                        <Link to="/about_us.php" style={{ fontSize: "14px" }}>
                          About Us
                        </Link>
                      </li>
                      <li>
                        <Link to="/contact_us.php" style={{ fontSize: "14px" }}>
                          Contact Us
                        </Link>
                      </li>
                    </ul>
                ...
                <div className="footer-widget links-widget">
                  ...
                  <div className="widget-content">
                    <ul className="list clearfix">
                      <li>
                        <a
                          href="https://appointment.blsslovakiavisa.com/app_azerbaijan/login"
                          target="_blank"
                          style={{ fontSize: "14px" }}
                        >
                          Book an appointment
              ...
              <div className="col-lg-3 col-md-6 col-sm-12 footer-column">
                <div className="footer-widget links-widget">
                  <div className="widget-title">
                    <h3 className="none_mob" style={{ fontSize: "22px" }}>
                      Visa services
                    </h3>
                  </div>
                  <div className="widget-content">
                ...
                <div className="footer-widget links-widget">
                  ...
                  <div className="widget-content">
                    <ul className="list clearfix">
                      ...
                      <li>
                        <Link to="/faqs.php" style={{ fontSize: "14px" }}>
                          FAQs
                        </Link>
                      </li>
                      <li>
        ...
        <div className="footer-bottom clearfix">
          <div className="copyright pull-left">
            <p style={{ fontSize: "14px" }}>
              (©) 2026{" "}
              <a
                href="https://blsinternational.com/"
                target="_blank"
                style={{ fontSize: "14px" }}
              >
                BLS International
          ...
          <ul className="footer-nav pull-right clearfix">
            <li>
              <Link to="/disclaimer.php" style={{ fontSize: "14px" }}>
                Disclaimer
              </Link>
            </li>
            <li>
              <Link to="/privacy-policy.php" style={{ fontSize: "14px" }}>
                Privacy policy
              </Link>
            </li>
            <li>
              <Link to="/cookies.php" style={{ fontSize: "14px" }}>
                Cookies policy
              </Link>
            </li>
            <li>
              <Link to="/copy_right_policy.php" style={{ fontSize: "14px" }}>
                Copyright policy
              </Link>
            </li>
            <li>
              <Link to="/app_india/login" style={{ fontSize: "14px" }}>
                Terms &amp; conditions
              </Link>
            </li>
          </ul>
