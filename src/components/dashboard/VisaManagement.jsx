            ...
            <tbody>
              {visas.map((visa, index) => (
                <tr
                  ...
                  style={{
                    borderBottom:
                      index !== visas.length - 1 ? "1px solid #e5e7eb" : "none",
                  }}
                >
                  <td
                    style={{
                  ...
                  >
                    {visa.visaGrantNumber || visa.trn || visa._id}
                  </td>
                  <td
                    style={{
                      padding: "12px 20px",
                  ...
                  >
                    {visa.givenNames} {visa.familyName}
                  </td>
                  <td
                    style={{
                      padding: "12px 20px",
          ...
          >
            ...
            >
              ...
              <div>
                ...
                <select
                  name="visaClassSubclass"
                  value={formData.visaClassSubclass}
                  onChange={handleInputChange}
                  style={{
                    width: "100%",
                    padding: "8px 12px",
                ...
                >
                  ...
                  <option value="Visit Family or Friends">
              ...
              <div>
                ...
                <input
                  type="date"
                  name="mustNotArriveAfter"
                  value={formData.mustNotArriveAfter}
                  onChange={handleInputChange}
                  style={{
                    width: "100%",
                    padding: "8px 12px",
              ...
              <div>
                ...
                <input
                  type="date"
                  name="enterBeforeDate"
                  value={formData.enterBeforeDate}
                  onChange={handleInputChange}
                  style={{
                    width: "100%",
                    padding: "8px 12px",
              ...
              <div style={{ gridColumn: "1 / -1" }}>
                ...
                <input
                  ...
                  placeholder="Custom name for the uploaded document"
                  onChange={handleInputChange}
                  style={{
                    width: "100%",
                    padding: "8px 12px",
